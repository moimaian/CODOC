...
from MODULES.module_requirements import RequirementsInstaller, detect_hardware, detect_opencl_devices, get_boost_version, get_vina_gpu_version
...
class MainWindow(QMainWindow):
    ...
    def _build_config_tab(self) -> None:
        ...
        param_rows = [
            ...
            ("Poses", self.sp_poses, "Grid x size", self.sp_grid_x),
            ("Energy range", self.sp_energy, "Grid y size", self.sp_grid_y),
            ("Minimum RMSD", self.sp_min_rmsd, "Grid z size", self.sp_grid_z),
        ]
        ...
        settings_form.addWidget(QLabel("Grid spacing"), final_param_row, 0)
        settings_form.addWidget(self.sp_spacing, final_param_row, 1)
        settings_form.addWidget(QLabel("OpenCL platform"), final_param_row, 2)
        settings_form.addWidget(self.cb_opencl_platform, final_param_row, 3)
        settings_form.addWidget(QLabel("OpenCL device"), final_param_row + 1, 0)
        settings_form.addWidget(self.cb_opencl_device, final_param_row + 1, 1, 1, 3)
    ...
    def _build_targets_tab(self) -> None:
        ...
        self.sp_center_x = QDoubleSpinBox(); self.sp_center_x.setRange(-9999.0, 9999.0); self.sp_center_x.setDecimals(3); self.sp_center_x.setFixedWidth(target_field_width)
        self.sp_center_y = QDoubleSpinBox(); self.sp_center_y.setRange(-9999.0, 9999.0); self.sp_center_y.setDecimals(3); self.sp_center_y.setFixedWidth(target_field_width)
        self.sp_center_z = QDoubleSpinBox(); self.sp_center_z.setRange(-9999.0, 9999.0); self.sp_center_z.setDecimals(3); self.sp_center_z.setFixedWidth(target_field_width)
    ...
    def _build_results_tab(self) -> None:
        ...
        self.tbl_results.setFixedHeight(220)
